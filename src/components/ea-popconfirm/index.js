...
export class EaPopconfirm extends EaPopper {
    ...
    state = this.properties({
        ...
        "icon-color": {
            ...
            observer: (newVal) => {
                if (!CSS.supports('color', newVal)) return console.warn(`[EaPopconfirm] The color value ${newVal} is not supported.`);
        ...
        "hide-icon": {
            ...
            default: false,
            observer: (newVal) => {
                this.style.setProperty('--ea-popconfirm-title-icon-display', newVal ? 'none' : 'block');
            }
        },
        "confirm-button-text": {
            type: String,
    ...
    constructor() {
        ...
        const { titleContainer, titleIcon, titleContent } = this.#renderTitleContainer();
    ...
    #renderFooter() {
        ...
        return {
            footer,
            cancelButton: footer.querySelector('.ea-popconfirm__cancel') || this.querySelector('[data-cancel]'),
            confirmButton: footer.querySelector('.ea-popconfirm__confirm') || this.querySelector('[data-confirm]'),
        }
    }
    ...
    #initTriggerEvent = () => {
        const referenceSlot = this.#referenceElement.querySelector('slot[name="reference"]');
        referenceSlot.addEventListener('click', () => {
            const abortController = new AbortController();
            this.toggle();
