      ...
      switch (this.direction) {
        ...
        case "vertical": {
          ...
          for (let j = i; j < this.col + i; j++) {
            ...
            th_tr.innerHTML += getThTemplate_direction(
              items[j].getAttribute("label"),
              this.border
            );
            td_tr.innerHTML += getTdTemplate_direction(
              items[j].innerHTML,
              this.border,
              colspan
            );
    ...
    if (hasIcon) {
      this.shadowRoot.innerHTML += `
                <link rel="stylesheet" href="${
                  new URL("../ea-icon/index.css", import.meta.url).href
                }">
            `;
    }
  }
