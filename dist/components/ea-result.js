...
class S extends x {
  ...
  set icon(t) {
    t && (this.setAttribute("icon", t), n(this, l).innerHTML = `<ea-icon icon="${t}"></ea-icon>`);
  }
  // #endregion
  // ------- end -------
  // ------- title 设置标题 -------
  ...
  set title(t) {
    t && (this.setAttribute("title", t), n(this, a).innerText = t);
  }
  // #endregion
  // ------- end -------
  // ------- sub-title 设置副标题 -------
  ...
  set subtitle(t) {
    t && (this.setAttribute("sub-title", t), n(this, o).innerText = t);
  }
  // #endregion
  // ------- end -------
  connectedCallback() {
    this.icon = this.icon, this.title = this.title, this.subtitle = this.subtitle;
  }
}
