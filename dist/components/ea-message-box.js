...
class q extends k {
  ...
  set reg(t) {
    this.isPrompt && (s(this, m, t), n(this, l).addEventListener("change", (o) => {
      const a = o.detail.value;
      o.target.shadowRoot.querySelector(".ea-input_inner").setAttribute("aria-invalid", !t.test(a)), n(this, l).setAttribute("aria-invalid", !t.test(a)), t.test(a);
    }));
  }
  // #endregion
  // ------- end -------
  ...
  set inputPlaceholder(t) {
    t && (n(this, l).placeholder = t);
  }
  // #endregion
  // ------- end -------
  // ------- title 标题 -------
