...
var l = (t, a, e) => (s(t, a, "read from private field"), e ? e.call(t) : a.get(t)), c = (t, a, e) => {
  if (a.has(t))
    throw TypeError("Cannot add the same private member more than once");
  a instanceof WeakSet ? a.add(t) : a.set(t, e);
}, d = (t, a, e, o) => (s(t, a, "write to private field"), o ? o.call(t, e) : a.set(t, e), e);
var h = (t, a, e) => (s(t, a, "access private method"), e);
...
class p extends m {
  constructor() {
    ...
    e.innerHTML = `
        ...
        `, d(this, r, e.querySelector(".ea-container_wrap")), this.build(e, u);
  }
  get CONTAINER_TYPE() {
  ...
  set direction(e) {
    this.setAttribute("direction", e), l(this, r).classList.toggle("is-vertical", e === "horizontal");
  }
  connectedCallback() {
    const e = Array.from(this.children);
    h(this, n, f).call(this, e);
  }
}
r = new WeakMap(), n = new WeakSet(), f = function(e) {
...
customElements.get("ea-container") || customElements.define("ea-container", p);
export {
  p as EaContainer
};
