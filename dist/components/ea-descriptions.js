...
var f = (e, i, t) => (g(e, i, "read from private field"), t ? t.call(e) : i.get(e)), p = (e, i, t) => {
  if (i.has(e))
    throw TypeError("Cannot add the same private member more than once");
  i instanceof WeakSet ? i.add(e) : i.set(e, t);
}, w = (e, i, t, r) => (g(e, i, "write to private field"), r ? r.call(e, t) : i.set(e, t), t);
var y = (e, i, t) => (g(e, i, "access private method"), t);
...
const H = (e, i) => `
    ...
    `, k = (e, i, t) => {
  var c;
  let r = e.getAttribute("label"), l = e.innerHTML;
  return r || (r = ((c = e.querySelector('[slot="label"]')) == null ? void 0 : c.innerHTML) || ""), t ? M(r, l, i) : E(r, l, i);
}, C = `
...
class S extends x {
  constructor() {
    ...
    t.innerHTML = `
        ...
        `, w(this, b, t.querySelector(".ea-descriptions_table")), w(this, h, t.querySelector(".ea-descriptions_header")), this.build(t, C);
  }
  // ------- title 设置标题 -------
  // #region
  get title() {
  ...
  set title(t) {
    this.setAttribute("title", t), f(this, h).innerHTML = t;
  }
  // #endregion
  // ------- end -------
  // ------- col 一行显示多少个item -------
  ...
  connectedCallback() {
    ...
    y(this, m, $).call(this, t), y(this, u, v).call(this);
  }
}
b = new WeakMap(), h = new WeakMap(), m = new WeakSet(), $ = function(t) {
  var l, c, T;
  const r = Number(t.length);
  for (let s = 0; s < r; s += 3) {
    let A = 0;
    const d = document.createElement("tbody");
    switch (d.part = "table-tbody", this.direction) {
      case "horizontal": {
        const n = document.createElement("tr");
        n.part = "table-tr";
        for (let a = s; a < this.col + s; a++) {
          const o = Number((l = t[a]) == null ? void 0 : l.getAttribute("span")) || 1;
          if (A + o > this.col || !t[a])
            break;
      ...
      case "vertical": {
        ...
        for (let o = s; o < this.col + s; o++) {
          const _ = Number((c = t[o]) == null ? void 0 : c.getAttribute("span")) || 1;
          if (A + _ > this.col || !t[o])
            break;
          n.innerHTML += H(t[o].getAttribute("label"), this.border), a.innerHTML += L(t[o].innerHTML, this.border, _);
        }
        d.appendChild(n), d.appendChild(a);
        break;
      }
    }
    f(this, b).appendChild(d);
  }
  t.forEach((s) => {
    s.remove();
  }), (T = this.shadowRoot) == null || T.querySelectorAll("[slot]").forEach((s) => {
    s.remove();
  });
