...
class u extends p {
  ...
  set checked(e) {
    this.setAttribute("checked", e), t(this, o).setAttribute("checked", e), t(this, i).checked = e, t(this, o).classList.toggle("checked", e);
  }
  // #endregion
  // ------- end -------
  // ------- label_for 单选框的唯一键 -------
  ...
  set name(e) {
    this.setAttribute("name", e), t(this, i).setAttribute("name", e);
  }
  // #endregion
  // ------- end -------
  // ------- value 单选框的值 -------
  ...
  set value(e) {
    this.setAttribute("value", e), t(this, o).setAttribute("for", e), t(this, i).setAttribute("id", e), t(this, i).setAttribute("value", e);
  }
  // #endregion
  // ------- end -------
  // ------- disabled 禁用状态 -------
  ...
  set disabled(e) {
    t(this, i).disabled = e, t(this, o).setAttribute("disabled", e), t(this, o).classList.toggle("disabled", e);
  }
  // #endregion
  // ------- end -------
  // ------- border 是否带有边框 -------
  ...
  set border(e) {
    t(this, o).classList.toggle("border", e);
  }
  // #endregion
  // ------- end -------
  connectedCallback() {
