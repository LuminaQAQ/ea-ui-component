...
class u extends w {
  constructor() {
    ...
    this.stylesheet = p, e.innerHTML = `
        ...
        `, r(this, h, e.querySelector(".ea-switch_wrap")), r(this, c, e.querySelector(".ea-switch_input")), r(this, l, e.querySelector(".ea-switch_label--left")), r(this, n, e.querySelector(".ea-switch_core")), r(this, o, e.querySelector(".ea-switch_label--right"));
  }
  // ------- name 属性 -------
  // #region
  get name() {
  ...
  set name(e) {
    this.setAttribute("name", e), a(this, h).setAttribute("for", e), a(this, c).setAttribute("name", e), a(this, c).setAttribute("id", e);
  }
  // #endregion
  // ------- end -------
  // ------- value 属性 -------
  // #region
  get value() {
    return this.inactiveText && !this.checked ? this.inactiveText : this.activeText && this.checked ? this.activeText : this.checked;
  }
  set value(e) {
    a(this, c).value = e;
  }
  ...
  set inactiveText(e) {
    e && (this.setAttribute("inactive-text", e), a(this, l).innerText = e);
  }
  // #endregion
  // ------- end -------
  // ------- active-text 开启时选项 -------
  ...
  set activeText(e) {
    e && (this.setAttribute("active-text", e), a(this, o).innerText = e);
  }
  // #endregion
  // ------- end -------
  // ------- checked 选中 -------
  ...
  set checked(e) {
    this.setAttribute("checked", e), a(this, c).checked = e;
  }
  // #endregion
  // ------- end -------
  // ------- disabled 禁用 -------
  ...
  set disabled(e) {
    this.setAttribute("disabled", e), a(this, c).disabled = e, a(this, h).classList.toggle("disabled", e);
  }
  // #endregion
  // ------- end -------
  ...
  set inactiveColor(e) {
    e && this.style.setProperty("--inactive-checkbox-bgc", e);
  }
  // #endregion
  // ------- end -------
  // ------- active-color 开启时颜色 -------
  ...
  set activeColor(e) {
    e && this.style.setProperty("--active-checkbox-bgc", e);
  }
  // #endregion
  // ------- end -------
  connectedCallback() {
    this.setAttribute("data-ea-component", !0), this.name = this.name, this.value = this.value, this.checked = this.checked, this.inactiveText = this.inactiveText, this.activeText = this.activeText, this.disabled = this.disabled, this.inactiveColor = this.inactiveColor, this.activeColor = this.activeColor, a(this, c).addEventListener("change", (e) => {
      e.preventDefault(), e.stopPropagation(), this.checked = e.target.checked, this.dispatchEvent(new CustomEvent("change", {
        detail: {
