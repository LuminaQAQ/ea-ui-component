...
class y extends g {
  ...
  set description(t) {
    this.setAttribute("description", t), p(this, r).innerHTML = t;
  }
  // #endregion
  // ------- end -------
  // ------- image 自定义图片 -------
  ...
  set imageSize(t) {
    t && (this.setAttribute("image-size", t), p(this, s).style.width = t + "px");
  }
  // #endregion
  // ------- end -------
  connectedCallback() {
    this.description = this.description, this.image = this.image, this.imageSize = this.imageSize;
  }
}
