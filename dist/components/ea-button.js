...
var f = (a, e, t) => e in a ? p(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t;
var s = (a, e, t) => f(a, typeof e != "symbol" ? e + "" : e, t), l = (a, e, t) => e.has(a) || d("Cannot " + t);
var u = (a, e, t) => (l(a, e, "read from private field"), t ? t.call(a) : e.get(a)), c = (a, e, t) => e.has(a) ? d("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(a) : e.set(a, t), b = (a, e, t, r) => (l(a, e, "write to private field"), r ? r.call(a, t) : e.set(a, t), t);
...
class g extends h {
  constructor() {
      ...
      loading: {
        ...
        observer: (t) => {
          ...
          if (t) {
            ...
            n.id = "ea-loading-icon", n.icon = "icon-spin6 animate-spin", n.size = this.state.size, u(this, o).insertBefore(n, u(this, o).firstChild);
          } else {
            const n = (r = u(this, o)) == null ? void 0 : r.querySelectorAll("#ea-loading-icon");
            (n == null ? void 0 : n.length) > 0 && (n == null || n.forEach((v) => v.remove()));
          }
          this.computedClasslist();
        }
      }
    ...
    this.stylesheet = w, this.getAttribute("href") ? (t.innerHTML = y, b(this, i, "a")) : (t.innerHTML = m, b(this, i, "button")), b(this, o, t.querySelector(".ea-button"));
  }
  // ------- 禁用 -------
  // #region
  get disabled() {
  ...
  set icon(t) {
    if (this.setAttribute("icon", t), t && !u(this, o).querySelector("ea-icon")) {
      ...
      r.size = this.size, r.icon = t, r.part = "icon", u(this, o).insertBefore(r, u(this, o).firstChild);
    }
  }
  // #endregion
  // ------- end -------
  ...
  set href(t) {
    u(this, i) !== "button" && (this.setAttribute("href", t), u(this, o).setAttribute("href", t));
  }
  // #endregion
  // ------- end -------
  // ------- 按钮大小 -------
  ...
  // ------- end -------
  $mounted() {
    this.plain = this.getAttribute("plain"), this.round = this.getAttribute("round"), this.text = this.getAttribute("text"), this.circle = this.getAttribute("circle"), this.type = this.getAttribute("type"), this.size = this.getAttribute("size"), this.icon && (this.icon = this.icon), this.link = this.getAttribute("link"), this.link && (this.href = this.href), this.disabled = this.getAttrBoolean("disabled"), this.getAttrBoolean("loading") && (this.loading = this.getAttribute("loading"));
  }
}
i = new WeakMap(), o = new WeakMap(), s(g, "observedProps", ["disabled", "type", "text", "plain", "round", "cicle", "link", "icon", "loading"]);
window.customElements.get("ea-button") || window.customElements.define("ea-button", g);
export {
  g as EaButton
};
