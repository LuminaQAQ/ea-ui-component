...
class u extends b {
  ...
  set checked(e) {
    this.setAttribute("checked", e), a(this, i).checked = e;
  }
  // #endregion
  // ------- end -------
  // ------- name 单选框的唯一键 -------
  ...
  set name(e) {
    this.setAttribute("name", e), a(this, i).setAttribute("name", e);
  }
  // #endregion
  // ------- end -------
  // ------- value 单选框的值 -------
  ...
  set value(e) {
    this.setAttribute("value", e), a(this, n).setAttribute("for", e), a(this, i).setAttribute("id", e), a(this, i).setAttribute("value", e);
  }
  // #endregion
  // ------- end -------
  // ------- disabled 禁用状态 -------
  ...
  set disabled(e) {
    this.setAttribute("disabled", e), a(this, i).disabled = e;
  }
  // #endregion
  // ------- end -------
  // ------- border 是否带有边框 -------
  ...
  set border(e) {
    a(this, n).classList.toggle("border", e);
  }
  // #endregion
  // ------- end -------
  // ------- indeterminate 状态 -------
  ...
  set indeterminate(e) {
    this.setAttribute("indeterminate", e), a(this, i).setAttribute("indeterminate", e), e && (this.checked = !1, a(this, n).classList.remove("checked"), this.setAttribute("indeterminate", !0), a(this, i).setAttribute("indeterminate", !0));
  }
  // #endregion
  // ------- end -------
  connectedCallback() {
    this.checked = this.checked, this.name = this.name, this.value = this.value, this.disabled = this.disabled, this.border = this.border, this.indeterminate = this.indeterminate, a(this, i).addEventListener("change", (e) => {
      e.preventDefault(), this.indeterminate = !1, this.checked = e.target.checked, this.dispatchEvent(new CustomEvent("change", {
        bubbles: !0,
        composed: !0,
        detail: {
