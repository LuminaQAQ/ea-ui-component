var g=(e,i,t)=>{if(!i.has(e))throw TypeError("Cannot "+t)};var f=(e,i,t)=>(g(e,i,"read from private field"),t?t.call(e):i.get(e)),p=(e,i,t)=>{if(i.has(e))throw TypeError("Cannot add the same private member more than once");i instanceof WeakSet?i.add(e):i.set(e,t)},w=(e,i,t,r)=>(g(e,i,"write to private field"),r?r.call(e,t):i.set(e,t),t);var y=(e,i,t)=>(g(e,i,"access private method"),t);import{B as x}from"./Base.LSgLRpFA.js";import"./index.CcHcFfiA.js";import"./index.BSyUhE6H.js";const H=(e,i)=>`
...
`;var b,h,m,$,u,v;class S extends x{constructor(){super();p(this,m);p(this,u);p(this,b,void 0);p(this,h,void 0);const t=this.attachShadow({mode:"open"});t.innerHTML=`
