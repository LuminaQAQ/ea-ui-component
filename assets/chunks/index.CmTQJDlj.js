var T=(i,a,t)=>{if(!a.has(i))throw TypeError("Cannot "+t)};var s=(i,a,t)=>(T(i,a,"read from private field"),t?t.call(i):a.get(i)),r=(i,a,t)=>{if(a.has(i))throw TypeError("Cannot add the same private member more than once");a instanceof WeakSet?a.add(i):a.set(i,t)},o=(i,a,t,e)=>(T(i,a,"write to private field"),e?e.call(i,t):a.set(i,t),t);var E=(i,a,t)=>(T(i,a,"access private method"),t);import{B as z}from"./Base.yCeCPjNm.js";import"./index.CpoGCwi-.js";import{c as d,a as S}from"./createElement.BM9xfELw.js";const I=`
