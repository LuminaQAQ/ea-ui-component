var o=(e,s,t)=>{if(!s.has(e))throw TypeError("Cannot "+t)};var d=(e,s,t)=>(o(e,s,"read from private field"),t?t.call(e):s.get(e)),r=(e,s,t)=>{if(s.has(e))throw TypeError("Cannot add the same private member more than once");s instanceof WeakSet?s.add(e):s.set(e,t)},h=(e,s,t,a)=>(o(e,s,"write to private field"),a?a.call(e,t):s.set(e,t),t);import{B as l}from"./Base.yCeCPjNm.js";import"./index.CpoGCwi-.js";import"./createElement.BM9xfELw.js";const n=`
.ea-aside_wrap {
  height: 100%;
  overflow: auto;
  display: flex;
