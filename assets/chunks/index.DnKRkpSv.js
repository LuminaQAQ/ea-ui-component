...
.ea-radio-group ea-radio {
  margin-right: 2rem;
}`;class S extends p{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("div");t.appendChild(e);const r=document.createElement("slot");e.className="ea-radio-group",e.appendChild(r),this.dom=e,this.build(t,N),t.appendChild(e)}get name(){return this.getAttribute("name")}set name(t){this.querySelectorAll("ea-radio").forEach(e=>{e.setAttribute("name",t)})}init(){this.name=this.name}connectedCallback(){this.init()}}const T=`:host {
  --margin-right: 1rem;
}
