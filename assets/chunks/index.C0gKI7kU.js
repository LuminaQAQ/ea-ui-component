var Q=(a,i,e)=>{if(!i.has(a))throw TypeError("Cannot "+e)};var r=(a,i,e)=>(Q(a,i,"read from private field"),e?e.call(a):i.get(a)),c=(a,i,e)=>{if(i.has(a))throw TypeError("Cannot add the same private member more than once");i instanceof WeakSet?i.add(a):i.set(a,e)},n=(a,i,e,t)=>(Q(a,i,"write to private field"),t?t.call(a,e):i.set(a,e),e);function ie(a,i){const e=document.createElement("link");e.href=i,e.rel="stylesheet",a.appendChild(e)}class m extends HTMLElement{constructor(){super(),this.isProduction=!1,this.isProduction=!0}toggleAttribute(i,e,t){e?(this.setAttribute(i,e),t&&this.dom.classList.add(t)):(this.hasAttribute(i)&&this.removeAttribute(i),t&&this.dom.classList.remove(t))}toggleAttr(i,e){e?this.setAttribute(i,e):this.removeAttribute(i)}getAttrBoolean(i){const e=this.getAttribute(i);return e==="true"||e===""}build(i,e){if(this.isProduction){const t=document.createElement("style");t.innerHTML=e,this.shadowRoot.appendChild(t)}else ie(i,new URL(this.nodeName.toLowerCase()+"/index.css",import.meta.url).href)}}const oe=`
...
`;class ne extends HTMLElement{constructor(){super();const i=this.attachShadow({mode:"open"}),e=document.createElement("div");i.appendChild(e);const t=document.createElement("slot");e.className="__ea-button-group",e.appendChild(t),this.dom=e;const o=document.createElement("style");o.innerHTML=se,this.shadowRoot.appendChild(o),i.appendChild(e)}connectedCallback(){Array.from(this.children).map((i,e,t)=>{const o=i.shadowRoot?i.shadowRoot.querySelector("button"):i;e===0?o.style.setProperty("--border-radius","4px 0 0 4px"):e===t.length-1?o.style.setProperty("--border-radius","0 4px 4px 0"):o.style.setProperty("--border-radius","0")})}}const ce=`
@import url('/ea_ui_component/icon/index.css');
...
`,Ge={dashboard:`
    ...
    `};var N,B,g,v;class Ye extends m{constructor(){super();c(this,N,void 0);c(this,B,void 0);c(this,g,void 0);c(this,v,void 0);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-progress_wrap";const o=document.createElement("section");o.className="ea-progress_track";const s=document.createElement("section");s.className="ea-progress_path",o.appendChild(s),t.appendChild(o);const d=document.createElement("section");d.className="ea-progress_text",t.appendChild(d),n(this,N,t),n(this,B,o),n(this,g,s),n(this,v,d),this.build(e,Fe),this.shadowRoot.appendChild(t)}handleSVGTemplate(e){r(this,N).style.height="126px",r(this,N).style.width="126px",r(this,N).innerHTML=Ge[e];const t=r(this,N).querySelector(`circle[class="track--${e}"]`),o=r(this,N).querySelector(`circle[class="path--${e}"]`),s=r(this,N).querySelector(`span[class="ea-progress_text--${e}"]`);n(this,B,t),n(this,g,o),n(this,v,s)}get type(){return this.getAttribute("type")}set type(e){if(!(e==null||e===""))switch(this.setAttribute("type",e),this.type){case"circle":this.handleSVGTemplate("circle");break;case"dashboard":this.handleSVGTemplate("dashboard");break}}get percentage(){return this.getAttribute("percentage")||0}getCirclePercentageValue(e){return 302*(100-Number(e))/100}getDashboardPercentageValue(e){return 152*(100-Number(e))/100+100}set percentage(e){if(!(e==null||e===""))switch(Number(e)<0?e=0:Number(e)>100&&(e=100),this.setAttribute("percentage",e),r(this,v).innerHTML=`${e}%`,this.type){case"circle":{r(this,g).style.strokeDashoffset=`${this.getCirclePercentageValue(e)}px`;break}case"dashboard":{r(this,g).style.strokeDashoffset=`${this.getDashboardPercentageValue(e)}px`;break}default:{r(this,g).style.width=`${e}%`,this.textInside&&this.handleTextInside(e);break}}}get statusList(){return{success:{icon:"icon-ok-circled",color:"#67c23a"},warning:{icon:"icon-attention-circled",color:"#e6a23c"},exception:{icon:"icon-cancel-circled",color:"#f56c6c"},primary:""}}handleStatusStyle(e,t){r(this,v).innerText=this.statusList[e]?"":`${this.percentage}%`,r(this,v).className=`${t} ${this.statusList[e].icon||""}`,r(this,v).style.color=this.statusList[e].color}get status(){return this.getAttribute("status")||"primary"}set status(e){switch(this.setAttribute("status",e),r(this,g).style.stroke=this.statusList[e].color,this.type){case"circle":this.handleStatusStyle(e,"ea-progress_text--circle");break;case"dashboard":this.handleStatusStyle(e,"ea-progress_text--dashboard");break;default:this.handleStatusStyle(e,"ea-progress_text");break}}handleTextInside(e){this.type!=="circle"&&(e?(r(this,v).style.display="none",r(this,g).innerText=`${this.percentage}%`):(r(this,v).style.display="block",r(this,g).innerText=""))}get textInside(){return this.getAttrBoolean("text-inside")}set textInside(e){this.setAttribute("text-inside",e),this.handleTextInside(e)}get strokeWidth(){return this.getAttribute("stroke-width")}set strokeWidth(e){e=e||4,this.toggleAttr("stroke-width",e),this.type==="circle"?(r(this,B).style.strokeWidth=`${Number(e)}px`,r(this,g).style.strokeWidth=`${Number(e)}px`):(e=Number(e)+4,r(this,B).style.height=`${e}px`,r(this,B).style.lineHeight=`${e}px`,r(this,g).style.height=`${e}px`,r(this,g).style.lineHeight=`${e}px`)}init(){this.type=this.type,this.percentage=this.percentage,this.status=this.status,this.textInside=this.textInside,this.strokeWidth=this.strokeWidth}connectedCallback(){this.init()}}N=new WeakMap,B=new WeakMap,g=new WeakMap,v=new WeakMap;const b=(a,i)=>{window.customElements.get(a)||window.customElements.define(a,i)};b("ea-button",ae);b("ea-button-group",ne);b("ea-link",de);b("ea-radio",pe);b("ea-radio-group",ge);b("ea-checkbox",we);b("ea-checkbox-group",ke);b("ea-input",Le);b("ea-textarea",Ne);b("ea-input-number",Ie);b("ea-select",Re);b("ea-switch",De);b("ea-rate",Me);b("ea-tag",Oe);b("ea-progress",Ye);
