var T=(o,a,t)=>{if(!a.has(o))throw TypeError("Cannot "+t)};var i=(o,a,t)=>(T(o,a,"read from private field"),t?t.call(o):a.get(o)),s=(o,a,t)=>{if(a.has(o))throw TypeError("Cannot add the same private member more than once");a instanceof WeakSet?a.add(o):a.set(o,t)},u=(o,a,t,e)=>(T(o,a,"write to private field"),e?e.call(o,t):a.set(o,t),t);var r=(o,a,t)=>(T(o,a,"access private method"),t);import{B as Q}from"./Base.yCeCPjNm.js";import"./index.DhjvHksS.js";import{c as U}from"./createElement.BM9xfELw.js";import{t as H}from"./timeout.ZZWNqneZ.js";import"./index.CJHvb1_x.js";import"./ea-button.B2M6Cckg.js";const V=`
...
`;var w,h,k,b,_,f,E,p,c,S,$,q,F,P,j,v,L,C,G,D,J,I,K;class X extends Q{constructor(){super();s(this,p);s(this,S);s(this,q);s(this,P);s(this,v);s(this,C);s(this,D);s(this,I);s(this,w,void 0);s(this,h,void 0);s(this,k,void 0);s(this,b,void 0);s(this,_,void 0);s(this,f,void 0);s(this,E,!1);const t=this.attachShadow({mode:"open"});t.innerHTML=`
        ...
        `,u(this,w,t.querySelector(".ea-time-picker_wrap")),u(this,h,t.querySelector("ea-input")),u(this,k,t.querySelector(".ea-time-picker_dropdown-wrap")),u(this,b,t.querySelector(".ea-time-picker_dropdown-inner-hour")),u(this,_,t.querySelector(".ea-time-picker_dropdown-inner-minute")),u(this,f,t.querySelector(".ea-time-picker_dropdown-inner-second")),this.build(t,V)}get width(){return this.getAttribute("width")||"200px"}set width(t){this.setAttribute("width",t),i(this,w).style.width=t}get time(){return this.getAttribute("time")||"00:00:00"}set time(t){this.setAttribute("time",t);const[e,n,d]=t.split(":");this.hour=e,this.minute=n,this.second=d}get name(){return this.getAttribute("name")||"timePicker"}set name(t){this.setAttribute("name",t)}get hour(){const t=this.getAttrNumber("hour");return r(this,p,c).call(this,t)}set hour(t){this.setAttribute("hour",t),r(this,S,$).call(this,i(this,b),t)}get minute(){const t=this.getAttrNumber("minute");return r(this,p,c).call(this,t)}set minute(t){this.setAttribute("minute",t),r(this,S,$).call(this,i(this,_),t)}get second(){const t=this.getAttrNumber("second");return r(this,p,c).call(this,t)}set second(t){this.setAttribute("second",t),r(this,S,$).call(this,i(this,f),t)}get value(){return this.time}set value(t){this.time=t}get disabled(){return this.getAttrBoolean("disabled")||!1}set disabled(t){this.setAttribute("disabled",t),i(this,h).disabled=t}get align(){return this.getAttribute("align")||"left"}set align(t){this.setAttribute("align",t),i(this,h).shadowRoot.querySelector("input").style.textAlign=t}get limitRangeStart(){var e;if(this.getAttribute("limit-range-start")){const[n,d,l]=(e=this.getAttribute("limit-range-start"))==null?void 0:e.split(":");return`${r(this,p,c).call(this,n)}:${r(this,p,c).call(this,d)}:${r(this,p,c).call(this,l)}`}else return"00:00:00"}set limitRangeStart(t){this.setAttribute("limit-range-start",t)}get limitRangeEnd(){var e;if(this.getAttribute("limit-range-end")){const[n,d,l]=(e=this.getAttribute("limit-range-end"))==null?void 0:e.split(":");return`${r(this,p,c).call(this,n)}:${r(this,p,c).call(this,d)}:${r(this,p,c).call(this,l)}`}else return"23:59:59"}set limitRangeEnd(t){this.setAttribute("limit-range-end",t)}connectedCallback(){r(this,I,K).call(this)}}w=new WeakMap,h=new WeakMap,k=new WeakMap,b=new WeakMap,_=new WeakMap,f=new WeakMap,E=new WeakMap,p=new WeakSet,c=function(t,e="00"){return t=Number(t),t<10?`0${t}`:t||e},S=new WeakSet,$=function(t,e){t.querySelectorAll("li").forEach(n=>{Number(n.innerText)===Number(r(this,p,c).call(this,e))&&n.click()})},q=new WeakSet,F=function(){i(this,k).style.width=i(this,h).getBoundingClientRect().width+"px",H(()=>{i(this,w).classList.add("with-transition")},50)},P=new WeakSet,j=function(t,e,n,d){t.addEventListener("click",()=>{n.querySelectorAll("li").forEach(N=>{N.classList.remove("is-active")}),t.classList.add("is-active");const x=r(this,p,c).call(this,e);switch(d){case"hour":this.hour=x;break;case"minute":this.minute=x;break;case"second":this.second=x;break}i(this,E)&&this.dispatchEvent(new CustomEvent("change",{detail:{time:this.time}})),i(this,h).value=`${this.hour}:${this.minute}:${this.second}`,this.time=`${this.hour}:${this.minute}:${this.second}`;const m=t.getBoundingClientRect().height*e;n.scrollTo({top:m,behavior:"smooth"})})},v=new WeakSet,L=function(t){t.addEventListener("wheel",()=>{H(()=>{const e=t.querySelectorAll("li"),n=e[0].getBoundingClientRect().height,{scrollTop:d}=t,l=Math.floor(d/n);e[l]&&e[l].click()},100)})},C=new WeakSet,G=function(){const[t,e,n]=this.limitRangeStart.split(":"),[d,l,x]=this.limitRangeEnd.split(":"),m=new Date,N=new Date(m.getFullYear(),m.getMonth(),m.getDate(),t,e,n),O=new Date(m.getFullYear(),m.getMonth(),m.getDate(),d,l,x);if(N>O)throw new Error("limit-range-start must be less than limit-range-end");const Y=(y,g,W,z)=>{y=Number(y),g=Number(g);let M=0,B=0;switch(z){case"hour":M=0,B=23;break;default:M=0,B=59,!String(y).localeCompare(g)&&t!==d&&(g=g===0?59:g)}for(let A=M;A<=B;A++){const R=U("li","ea-time-picker_dropdown-item");R.innerText=r(this,p,c).call(this,A),W.appendChild(R),A>=y&&A<=g?r(this,P,j).call(this,R,A,W,z):R.classList.add("is-disabled")}};Y(t,d,i(this,b),"hour"),Y(e,l,i(this,_),"minute"),Y(n,x,i(this,f),"second"),r(this,v,L).call(this,i(this,b)),r(this,v,L).call(this,i(this,_)),r(this,v,L).call(this,i(this,f))},D=new WeakSet,J=function(){let t=!1;const e=()=>{this.time=this.time,t=!0,u(this,E,!0),i(this,k).removeEventListener("transitionend",e)};i(this,h).addEventListener("focus",()=>{i(this,w).classList.add("is-open"),t||i(this,k).addEventListener("transitionend",e)}),window.addEventListener("click",n=>{this.contains(n.target)?i(this,h).shadowRoot.querySelector(".ea-input_inner").focus():i(this,w).classList.remove("is-open")})},I=new WeakSet,K=function(){this.name=this.name,this.width=this.width,this.disabled=this.disabled,this.align=this.align,this.limitRangeStart=this.limitRangeStart,this.limitRangeEnd=this.limitRangeEnd,r(this,q,F).call(this),r(this,C,G).call(this),this.time=this.time,i(this,h).value=`${this.hour}:${this.minute}:${this.second}`,r(this,D,J).call(this),this.setAttribute("data-ea-component",!0)};customElements.get("ea-time-picker")||customElements.define("ea-time-picker",X);export{X as EaTimePicker};
