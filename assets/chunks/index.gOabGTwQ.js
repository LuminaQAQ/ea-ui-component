var y=(r,a,e)=>{if(!a.has(r))throw TypeError("Cannot "+e)};var t=(r,a,e)=>(y(r,a,"read from private field"),e?e.call(r):a.get(r)),w=(r,a,e)=>{if(a.has(r))throw TypeError("Cannot add the same private member more than once");a instanceof WeakSet?a.add(r):a.set(r,e)},o=(r,a,e,i)=>(y(r,a,"write to private field"),i?i.call(r,e):a.set(r,e),e);var h=(r,a,e)=>(y(r,a,"access private method"),e);import{B as D}from"./Base.yCeCPjNm.js";import"./index.BXibZEVU.js";import{c as p,a as L}from"./createElement.BM9xfELw.js";const g=r=>(r==="false"||r===!1?r=!1:r=!0,r),v=`
