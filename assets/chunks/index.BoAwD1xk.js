...
}`,Ae=()=>{const o=document.createElement("span");o.className="__ea-radio-input_wrap";const a=document.createElement("span");a.className="__ea-radio-input_inner",o.appendChild(a);const e=document.createElement("input");return e.type="radio",e.className="__ea-radio-input_input",o.appendChild(e),{wrap:o,input:e}},Ce=()=>{const o=document.createElement("span");o.className="__ea-radio-label_desc";const a=document.createElement("slot");return o.appendChild(a),o};var C,w;class Ee extends g{constructor(){super();d(this,C,void 0);d(this,w,void 0);const e=this.attachShadow({mode:"open"});let t=document.createElement("label");t.className="ea-radio_wrap";const r=Ae();t.appendChild(r.wrap);const s=Ce();t.appendChild(s),n(this,w,t),n(this,C,r.input);const c=document.createElement("style");c.innerHTML=ye,this.shadowRoot.appendChild(c),e.appendChild(t)}static get observedAttributes(){return["checked"]}get checked(){return this.getAttrBoolean("checked")}set checked(e){i(this,C).checked=e,e?(this.setAttribute("checked",!0),i(this,w).setAttribute("checked",!0),i(this,w).classList.add("checked")):(this.removeAttribute("checked"),i(this,w).removeAttribute("checked"),i(this,w).classList.remove("checked"))}get name(){return this.getAttribute("name")}set name(e){i(this,C).setAttribute("name",e)}get value(){return this.getAttribute("value")}set value(e){i(this,w).setAttribute("for",e),i(this,C).setAttribute("id",e),i(this,C).setAttribute("value",e)}get disabled(){return this.getAttrBoolean("disabled")}set disabled(e){i(this,C).disabled=e,i(this,w).toggleAttribute("disabled",e),i(this,w).classList.toggle("disabled",e)}get border(){return this.getAttrBoolean("border")}set border(e){i(this,w).classList.toggle("border",e)}init(){const e=this;this.checked=this.checked,this.name=this.name,this.value=this.value,this.disabled=this.disabled,this.border=this.border,i(this,C).addEventListener("change",function(t){t.target.checked&&document.querySelectorAll(`ea-radio[name="${e.name}"]`).forEach(r=>{r.shadowRoot.querySelector("input")!==this?r.checked=!1:r.checked=!0})})}connectedCallback(){this.init()}attributeChangedCallback(e,t,r){}}C=new WeakMap,w=new WeakMap;const Le=`
.ea-radio-group {
  display: flex;
}
...
`,Ke=()=>{const o=document.createElement("input");return o.type="checkbox",o.className="ea-switch_input",o},Ze=()=>{const o=document.createElement("span");return o.className="ea-switch_core",o},pe=o=>{const a=document.createElement("span");return a.className=`ea-switch_label ea-switch_label--${o}`,a};var J,Q,v,B,y,M;class Je extends g{constructor(){super();d(this,J,!1);d(this,Q,void 0);d(this,v,void 0);d(this,B,void 0);d(this,y,void 0);d(this,M,void 0);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-switch_wrap";const r=Ke(),s=pe("left"),c=Ze(),u=pe("right");t.appendChild(r),t.appendChild(s),t.appendChild(c),t.appendChild(u),n(this,Q,t),n(this,v,r),n(this,B,s),n(this,y,c),n(this,M,u),this.build(e,Ye),this.shadowRoot.appendChild(t)}static get observedAttributes(){return["checked"]}get inactiveText(){return this.getAttribute("inactive-text")}set inactiveText(e){this.setAttribute("inactive-text",e),i(this,B).innerText=e}get activeText(){return this.getAttribute("active-text")}set activeText(e){this.setAttribute("active-text",e),i(this,M).innerText=e}get checked(){return this.getAttrBoolean("checked")}set checked(e){this.setAttribute("checked",e),i(this,v).checked=e,i(this,v).setAttribute("checked",e),e?(i(this,y).classList.add("ea-switch_core--checked"),i(this,M).classList.add("ea-switch_label--active"),i(this,B).classList.remove("ea-switch_label--active")):(i(this,y).classList.remove("ea-switch_core--checked"),i(this,B).classList.add("ea-switch_label--active"),i(this,M).classList.remove("ea-switch_label--active"))}get disabled(){return this.getAttrBoolean("disabled")}set disabled(e){this.setAttribute("disabled",e),i(this,v).disabled=e,i(this,Q).classList.toggle("ea-switch_wrap--disabled",e)}get inactiveColor(){return this.getAttribute("inactive-color")}set inactiveColor(e){e&&(this.setAttribute("inactive-color",e),e&&(i(this,y).style.backgroundColor=e))}get activeColor(){return this.getAttribute("active-color")}set activeColor(e){e&&(this.setAttribute("active-color",e),i(this,y).style.backgroundColor=e)}handleInputChecked(e){const t=i(this,v).checked;this.inactiveColor&&this.activeColor?i(this,y).style.backgroundColor=t?this.inactiveColor:this.activeColor:i(this,y).classList.toggle("ea-switch_core--checked",t)}init(){const e=this;this.checked=this.checked,this.inactiveText=this.inactiveText,this.activeText=this.activeText,this.disabled=this.disabled,this.activeColor&&this.inactiveColor&&(this.checked?this.activeColor=this.activeColor:this.inactiveColor=this.inactiveColor),i(this,B).addEventListener("click",function(t){e.checked=!i(e,v).checked}),i(this,M).addEventListener("click",function(t){e.checked=!i(e,v).checked}),i(this,y).addEventListener("click",function(t){e.checked=!i(e,v).checked})}connectedCallback(){this.init(),n(this,J,!0)}attributeChangedCallback(e,t,r){if(i(this,J)&&e==="checked"){const s=this.checked?this.activeText:this.inactiveText;this.handleInputChecked(),this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked,value:s}}))}}}J=new WeakMap,Q=new WeakMap,v=new WeakMap,B=new WeakMap,y=new WeakMap,M=new WeakMap;const Qe=`
@import url('/ea_ui_component/icon/index.css');
...
`,mt=o=>`
    ...
    `;var oe,se,f,ne;class ft extends g{constructor(){super();d(this,oe,void 0);d(this,se,void 0);d(this,f,void 0);d(this,ne,void 0);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-avatar_wrap";const r=document.createElement("span");r.className="ea-avatar",r.innerHTML=bt,t.appendChild(r);const s=document.createElement("slot");r.appendChild(s);const c=document.createElement("img");r.appendChild(c),n(this,oe,t),n(this,se,s),n(this,f,r),n(this,ne,c),this.build(e,pt),this.shadowRoot.appendChild(t)}get size(){const e=this.getAttrNumber("size"),t=this.getAttribute("size");return e===0||!e?["large","medium","small"].includes(t)?t:"normal":this.getAttrNumber("size")}set size(e){this.setAttribute("size",e),typeof e=="number"?(i(this,f).style.width=`${e}px`,i(this,f).style.height=`${e}px`,i(this,f).style.lineHeight=`${e}px`):typeof e=="string"&&i(this,f).classList.add(`ea-avatar--${e}`)}get shape(){const e=this.getAttribute("shape");return["circle","square"].includes(e)?e:"circle"}set shape(e){this.setAttribute("shape",e),i(this,f).classList.add(`ea-avatar--${this.shape}`)}get src(){return this.getAttribute("src")}set src(e){if(!e)return;const t=new Image;t.src=e,t.onload=()=>{this.setAttribute("src",e),i(this,f).innerHTML=`<img class="ea-avatar--img" src="${e}" alt="头像">`},t.onerror=r=>{this.setAttribute("src",e),i(this,f).innerHTML=gt,this.dispatchEvent(new CustomEvent("error",{detail:{error:r}}))}}get icon(){return this.getAttribute("icon")}set icon(e){this.setAttribute("icon",e),i(this,f).innerHTML=mt(e)}get fit(){return this.getAttribute("fit")||"cover"}set fit(e){this.setAttribute("fit",e),i(this,f).classList.add(`ea-avatar-fill--${e}`)}init(){this.size=this.size,this.shape=this.shape,this.src=this.src,this.src&&(this.fit=this.fit),!this.src&&this.icon&&(this.icon=this.icon),this.innerHTML!==""&&!this.icon&&!this.src&&(i(this,f).innerHTML=_t(this.innerHTML))}connectedCallback(){this.init()}}oe=new WeakMap,se=new WeakMap,f=new WeakMap,ne=new WeakMap;const b=(o,a)=>{window.customElements.get(o)||window.customElements.define(o,a)};b("ea-button",fe);b("ea-button-group",xe);b("ea-link",ve);b("ea-radio",Ee);b("ea-radio-group",ze);b("ea-checkbox",Pe);b("ea-checkbox-group",$e);b("ea-input",qe);b("ea-textarea",Ve);b("ea-input-number",Oe);b("ea-select",Ge);b("ea-switch",Je);b("ea-rate",et);b("ea-tag",rt);b("ea-progress",st);b("ea-pagination",lt);b("ea-badge",ut);b("ea-avatar",ft);
