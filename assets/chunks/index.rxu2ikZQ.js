...
`;var n;class h extends a{constructor(){super();l(this,n,void 0);const e=this.attachShadow({mode:"open"});e.innerHTML=`
    ...
    `,c(this,n,e.querySelector(".ea-link")),this.build(e,d)}get LINK_TYPE(){return["primary","success","info","warning","danger"]}get href(){return this.getAttribute("href")}set href(e){e&&(this.setAttribute("href",e),r(this,n).href=e)}get type(){const e=this.getAttribute("type");return this.LINK_TYPE.includes(e)?e:null}set type(e){e&&this.LINK_TYPE.includes(e)&&r(this,n).classList.add(e)}get disabled(){return this.getAttrBoolean("disabled")}set disabled(e){this.setAttribute("disabled",e),r(this,n).classList.toggle("disabled",e),this.style.cursor=e?"not-allowed":"pointer"}get underline(){return this.getAttrBoolean("underline")}set underline(e){r(this,n).classList.toggle("underline",e)}get icon(){return this.getAttribute("icon")}set icon(e){if(!e)return;const s=document.createElement("ea-icon");s.icon=e,r(this,n).insertBefore(s,r(this,n).firstChild)}connectedCallback(){this.style.display="inline-block",this.href=this.href,this.type=this.type,this.disabled=this.disabled,this.underline=this.underline,this.icon=this.icon}}n=new WeakMap;window.customElements.get("ea-link")||window.customElements.define("ea-link",h);export{h as EaLink};
