...
`;class a extends HTMLElement{constructor(){super();const r=this.attachShadow({mode:"open"}),o=document.createElement("div");r.appendChild(o);const t=document.createElement("slot");o.className="__ea-button-group",o.appendChild(t),this.dom=o;const e=document.createElement("style");e.innerHTML=n,this.shadowRoot.appendChild(e),r.appendChild(o)}connectedCallback(){Array.from(this.children).map((r,o,t)=>{const e=r.shadowRoot?r.shadowRoot.querySelector("button"):r;o===0?e.style.setProperty("--border-radius","4px 0 0 4px"):o===t.length-1?e.style.setProperty("--border-radius","0 4px 4px 0"):e.style.setProperty("--border-radius","0")})}}window.customElements.get("ea-button-group")||window.customElements.define("ea-button-group",a);export{a as EaButtonGroup};
