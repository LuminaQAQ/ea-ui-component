var f=(t,a,e)=>{if(!a.has(t))throw TypeError("Cannot "+e)};var r=(t,a,e)=>(f(t,a,"read from private field"),e?e.call(t):a.get(t)),n=(t,a,e)=>{if(a.has(t))throw TypeError("Cannot add the same private member more than once");a instanceof WeakSet?a.add(t):a.set(t,e)},s=(t,a,e,i)=>(f(t,a,"write to private field"),i?i.call(t,e):a.set(t,e),e);var u=(t,a,e)=>(f(t,a,"access private method"),e);import{B as S}from"./Base.yCeCPjNm.js";import"./index.DhjvHksS.js";import{a as k,c as d}from"./createElement.BM9xfELw.js";const T=`
