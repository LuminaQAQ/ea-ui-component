var g=(o,t,e)=>{if(!t.has(o))throw TypeError("Cannot "+e)};var n=(o,t,e)=>(g(o,t,"read from private field"),e?e.call(o):t.get(o)),u=(o,t,e)=>{if(t.has(o))throw TypeError("Cannot add the same private member more than once");t instanceof WeakSet?t.add(o):t.set(o,e)},h=(o,t,e,r)=>(g(o,t,"write to private field"),r?r.call(o,e):t.set(o,e),e);function f(o,t){const e=document.createElement("link");e.href=t,e.rel="stylesheet",o.appendChild(e)}class p extends HTMLElement{constructor(){super(),this.isProduction=!0}toggleAttribute(t,e,r){e?(this.setAttribute(t,e),r&&this.dom.classList.add(r)):(this.hasAttribute(t)&&this.removeAttribute(t),r&&this.dom.classList.remove(r))}getAttrBoolean(t){const e=this.getAttribute(t);return e==="true"||e===""}build(t,e){if(this.isProduction){const r=document.createElement("style");r.innerHTML=e,this.shadowRoot.appendChild(r)}else f(t,new URL(this.nodeName.toLowerCase()+"/index.css",import.meta.url).href)}}const k=`
...
`;class v extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("div");t.appendChild(e);const r=document.createElement("slot");e.className="__ea-button-group",e.appendChild(r),this.dom=e;const i=document.createElement("style");i.innerHTML=w,this.shadowRoot.appendChild(i),t.appendChild(e)}connectedCallback(){Array.from(this.children).map((t,e,r)=>{const i=t.shadowRoot?t.shadowRoot.querySelector("button"):t;e===0?i.style.setProperty("--border-radius","4px 0 0 4px"):e===r.length-1?i.style.setProperty("--border-radius","0 4px 4px 0"):i.style.setProperty("--border-radius","0")})}}const z=`
@import url('/ea_ui_component/icon/index.css');
...
`;class y extends p{constructor(){super();const t=this.attachShadow({mode:"open"});let e=document.createElement("a");const r=document.createElement("slot");e.className="__ea-link",e.appendChild(r),this.dom=e;const i=document.createElement("style");i.innerHTML=z,this.shadowRoot.appendChild(i),t.appendChild(e)}static get observedAttributes(){return["disabled"]}get LINK_TYPE(){return["primary","success","info","warning","danger"]}get href(){return this.getAttribute("href")}set href(t){t!==null&&(this.dom.href=t)}get type(){return this.getAttribute("type")}set type(t){if(t!==null){for(let e=0;e<this.LINK_TYPE.length;e++)if(t===this.LINK_TYPE[e]){this.dom.classList.add(t);break}}}get disabled(){return this.getAttribute("disabled")===""||this.getAttribute("disabled")==="true"}set disabled(t){t&&(t?this.dom.classList.add("disabled"):this.dom.classList.remove("disabled"))}get underline(){return this.getAttribute("underline")===""||this.getAttribute("underline")==="true"}set underline(t){t&&(t?this.dom.classList.add("underline"):this.dom.classList.remove("underline"))}get icon(){return this.getAttribute("icon")}set icon(t){if(t===null||t==="")return;const e=document.createElement("i");e.className=t,this.dom.insertBefore(e,this.dom.firstChild)}init(){this.href=this.href,this.type=this.type,this.disabled=this.disabled,this.underline=this.underline,this.icon=this.icon}connectedCallback(){this.init()}attributeChangedCallback(t,e,r){switch(t){case"disabled":this.disabled=r===""||r==="true"||r===!0;break}}}const A=`:host(ea-radio) {
...
}`,E=()=>{const o=document.createElement("span");o.className="__ea-radio-input_wrap";const t=document.createElement("span");t.className="__ea-radio-input_inner",o.appendChild(t);const e=document.createElement("input");return e.type="radio",e.className="__ea-radio-input_input",o.appendChild(e),{wrap:o,input:e}},C=()=>{const o=document.createElement("span");o.className="__ea-radio-label_desc";const t=document.createElement("slot");return o.appendChild(t),o};var s,d;class L extends p{constructor(){super();u(this,s,void 0);u(this,d,void 0);const e=this.attachShadow({mode:"open"});let r=document.createElement("label");r.className="ea-radio_wrap";const i=E();r.appendChild(i.wrap);const l=C();r.appendChild(l),h(this,d,r),h(this,s,i.input);const m=document.createElement("style");m.innerHTML=A,this.shadowRoot.appendChild(m),e.appendChild(r)}static get observedAttributes(){return["checked"]}get checked(){return this.getAttrBoolean("checked")}set checked(e){n(this,s).checked=e,e?(this.setAttribute("checked",!0),n(this,d).setAttribute("checked",!0),n(this,d).classList.add("checked")):(this.removeAttribute("checked"),n(this,d).removeAttribute("checked"),n(this,d).classList.remove("checked"))}get name(){return this.getAttribute("name")}set name(e){n(this,s).setAttribute("name",e)}get value(){return this.getAttribute("value")}set value(e){n(this,d).setAttribute("for",e),n(this,s).setAttribute("id",e),n(this,s).setAttribute("value",e)}get disabled(){return this.getAttrBoolean("disabled")}set disabled(e){n(this,s).disabled=e,n(this,d).toggleAttribute("disabled",e),n(this,d).classList.toggle("disabled",e)}get border(){return this.getAttrBoolean("border")}set border(e){n(this,d).classList.toggle("border",e)}init(){const e=this;this.checked=this.checked,this.name=this.name,this.value=this.value,this.disabled=this.disabled,this.border=this.border,n(this,s).addEventListener("change",function(r){r.target.checked&&document.querySelectorAll(`ea-radio[name="${e.name}"]`).forEach(i=>{i.shadowRoot.querySelector("input")!==this?i.checked=!1:i.checked=!0})})}connectedCallback(){this.init()}attributeChangedCallback(e,r,i){}}s=new WeakMap,d=new WeakMap;const N=`
.ea-radio-group {
  display: flex;
}
.ea-radio-group ea-radio {
  margin-right: 2rem;
}`;class T extends p{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("div");t.appendChild(e);const r=document.createElement("slot");e.className="ea-radio-group",e.appendChild(r),this.dom=e,this.build(t,N),t.appendChild(e)}get name(){return this.getAttribute("name")}set name(t){this.querySelectorAll("ea-radio").forEach(e=>{e.setAttribute("name",t)})}init(){this.name=this.name}connectedCallback(){this.init()}}const S=`:host {
  --margin-right: 1rem;
}
...
.ea-checkbox_wrap.indeterminate[checked=true] .__ea-checkbox-label_desc {
  color: #409eff;
}`,B=()=>{const o=document.createElement("span");o.className="__ea-checkbox-input_wrap";const t=document.createElement("span");t.className="__ea-checkbox-input_inner",o.appendChild(t);const e=document.createElement("input");return e.type="checkbox",e.className="__ea-checkbox-input_input",o.appendChild(e),{wrap:o,input:e}},R=()=>{const o=document.createElement("span");o.className="__ea-checkbox-label_desc";const t=document.createElement("slot");return o.appendChild(t),o};var c,a;class q extends p{constructor(){super();u(this,c,void 0);u(this,a,void 0);const e=this.attachShadow({mode:"open"});let r=document.createElement("label");r.className="ea-checkbox_wrap";const i=B();r.appendChild(i.wrap);const l=R();r.appendChild(l),h(this,a,r),h(this,c,i.input),this.build(e,S),e.appendChild(r)}static get observedAttributes(){return["checked","disabled"]}get checked(){return this.getAttrBoolean("checked")}set checked(e){n(this,c).checked=e,e?(this.setAttribute("checked",!0),n(this,a).setAttribute("checked",!0),n(this,a).classList.add("checked")):(this.removeAttribute("checked"),n(this,a).removeAttribute("checked"),n(this,a).classList.remove("checked"),n(this,a).classList.remove("indeterminate"))}get name(){return this.getAttribute("name")}set name(e){n(this,c).setAttribute("name",e)}get value(){return this.getAttribute("value")}set value(e){n(this,a).setAttribute("for",e),n(this,c).setAttribute("id",e),n(this,c).setAttribute("value",e)}get disabled(){return this.getAttrBoolean("disabled")}set disabled(e){n(this,c).disabled=e,n(this,a).toggleAttribute("disabled",e),n(this,a).classList.toggle("disabled",e)}get border(){return this.getAttrBoolean("border")}set border(e){n(this,a).classList.toggle("border",e)}get indeterminate(){return this.getAttrBoolean("indeterminate")}set indeterminate(e){e?(this.setAttribute("indeterminate",!0),n(this,a).classList.add("indeterminate")):(this.removeAttribute("indeterminate"),n(this,a).classList.remove("indeterminate"))}init(){const e=this;this.checked=this.checked,this.name=this.name,this.value=this.value,this.disabled=this.disabled,this.border=this.border,this.indeterminate=this.indeterminate,n(this,c).addEventListener("change",function(r){r.preventDefault(),e.checked=r.target.checked,r.target.checked})}connectedCallback(){this.init()}attributeChangedCallback(e,r,i){}}c=new WeakMap,a=new WeakMap;const P=`.ea-checkbox-group {
  display: flex;
}
.ea-checkbox-group ::slotted(ea-checkbox) {
  margin-right: 1.5rem;
}`;class $ extends p{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("div");t.appendChild(e);const r=document.createElement("slot");e.className="ea-checkbox-group",e.appendChild(r),this.dom=e,this.build(t,P),t.appendChild(e)}get name(){return this.getAttribute("name")}set name(t){this.querySelectorAll("ea-checkbox").forEach(e=>{e.setAttribute("name",t),e.name=t})}get value(){if(this.getAttribute("value"))return this.getAttribute("value")}set value(t){if(t)try{t.split(",").map(r=>r.trimStart()).map(r=>{const i=document.querySelector(`ea-checkbox[name="${this.name}"][value="${r}"]`);i.setAttribute("checked","true"),i.checked="true"})}catch{}}get disabled(){return this.getAttrBoolean("disabled")}set disabled(t){document.querySelectorAll(`ea-checkbox[name="${this.name}"]`).forEach(r=>{r.setAttribute("disabled","true"),r.disabled="true"})}init(){this.name=this.name,this.value=this.value,this.disabled=this.disabled}connectedCallback(){this.init()}}const b=(o,t)=>{window.customElements.get(o)||window.customElements.define(o,t)};b("ea-button",x);b("ea-button-group",v);b("ea-link",y);b("ea-radio",L);b("ea-radio-group",T);b("ea-checkbox",q);b("ea-checkbox-group",$);
