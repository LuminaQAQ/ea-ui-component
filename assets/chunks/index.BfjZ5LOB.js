...
`,We=()=>{let o=document.createElement("textarea");return o.className="ea-textarea_inner",o};var R,p,j;class Ve extends g{constructor(){super();d(this,R,void 0);d(this,p,void 0);d(this,j,!1);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-textarea_wrap",n(this,R,t);const r=We();n(this,p,r),i(this,R).appendChild(r),this.build(e,De),this.shadowRoot.appendChild(t)}get value(){return i(this,j)||(i(this,p).value=this.getAttribute("value")||""),this.getAttribute("value")}set value(e){e&&(this.setAttribute("value",e),i(this,p).value=e)}get placeholder(){return this.getAttribute("placeholder")||""}set placeholder(e){this.setAttribute("placeholder",e),i(this,p).placeholder=e}get rows(){return this.getAttribute("rows")||2}set rows(e){e&&(this.setAttribute("rows",e),i(this,p).rows=e,i(this,p).setAttribute("rows",e))}get autosize(){return this.getAttrBoolean("autosize")}set autosize(e){e&&(this.setAttribute("autosize",e),i(this,p).addEventListener("input",t=>{if(t.target.type==="textarea"){const r=i(this,p).cols,s=t.target.value.length;let c=Math.ceil(s/r)<=Number(i(this,p).rows)?Number(i(this,p).rows):Math.ceil(s/r);s%r==1&&(this.minRows>c?this.setTextareaHeight(this.minRows):this.maxRows<c?this.setTextareaHeight(this.maxRows):this.setTextareaHeight(c))}}))}setTextareaHeight(e){e=Number(e),i(this,p).rows=e}get minRows(){const e=Number(this.getAttribute("min-rows"));return e!==0&&e>0?e:1}set minRows(e){e&&(this.setAttribute("min-rows",e),this.setTextareaHeight(Number(e)))}get maxRows(){const e=Number(this.getAttribute("max-rows"));return e!==0&&e>0?e:10}set maxRows(e){e&&(this.setAttribute("max-rows",e),this.setTextareaHeight(Number(e)))}get maxLength(){return this.getAttribute("max-length")}set maxLength(e){e&&(this.setAttribute("max-length",e),i(this,p).maxLength=e,i(this,p).addEventListener("input",t=>{t.target.value.length>e&&(t.target.value=t.target.value.slice(0,e))}),this.showWordLimit&&(this.showWordLimit=!0))}get minLength(){return this.getAttribute("min-length")}set minLength(e){e&&(this.setAttribute("min-length",e),i(this,p).minLength=e,i(this,p).addEventListener("input",t=>{t.target.value.length<e?t.target.classList.add("invalid"):t.target.classList.remove("invalid")}))}get showWordLimit(){return this.getAttrBoolean("show-word-limit")}set showWordLimit(e){if(!e)return;this.setAttribute("show-word-limit",e);const t=document.createElement("span");i(this,R).classList.toggle("word-limit",e),i(this,R).classList.toggle("append-slot",e),t.className="ea-input_word-limit",t.innerText=`${i(this,p).value.length}/${this.maxLength}`,i(this,p).addEventListener("input",r=>{t.innerText=`${r.target.value.length}/${this.maxLength}`}),i(this,R).appendChild(t)}init(){this.placeholder=this.placeholder,this.value=this.value,this.disabled=this.disabled,this.autosize=this.autosize,this.maxRows&&(this.maxRows=this.maxRows),this.minRows&&(this.minRows=this.minRows),this.rows=this.rows,this.maxLength=this.maxLength,this.minLength=this.minLength,i(this,p).addEventListener("input",e=>{this.dispatchEvent(new CustomEvent("change",{detail:{value:e.target.value}}))}),i(this,p).addEventListener("focus",e=>{this.dispatchEvent(new CustomEvent("focus",{detail:{value:e.target.value}}))}),i(this,p).addEventListener("blur",e=>{this.dispatchEvent(new CustomEvent("blur",{detail:{value:e.target.value}}))})}connectedCallback(){this.init(),n(this,j,!0)}}R=new WeakMap,p=new WeakMap,j=new WeakMap;const Ue=`
@import url('/ea_ui_component/icon/index.css');
...
`,it=()=>{const o=document.createElement("i");return o.className="icon-cancel-circled2",o.style.cssText=`
        ...
        margin-left: 0.5rem;
        cursor: pointer;
    `,o};var G,te;class rt extends g{constructor(){super();d(this,G,void 0);d(this,te,void 0);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-tag_wrap";const r=document.createElement("slot");t.appendChild(r);const s=document.createElement("slot");s.name="close",t.appendChild(s),n(this,G,t),n(this,te,s),this.build(e,tt),this.shadowRoot.appendChild(t)}get type(){return this.getAttribute("type")||"default"}set type(e){this.setAttribute("type",e),i(this,G).classList.add(`ea-tag--${e}`)}get closable(){return this.getAttrBoolean("closable")}set closable(e){this.toggleAttr("closable",e)}get effect(){return this.getAttribute("effect")||"light"}set effect(e){e!=="light"&&(this.setAttribute("effect",e),i(this,G).classList.add(`ea-tag--${e}`))}initCloseEvent(){const e=this,t=it();t.addEventListener("mouseenter",function(r){t.className="icon-cancel-circled"}),t.addEventListener("mouseleave",function(r){t.className="icon-cancel-circled2"}),t.addEventListener("click",function(r){e.dispatchEvent(new CustomEvent("close",{detail:{value:e.innerText},bubbles:!0}))}),i(this,te).appendChild(t)}init(){this.type=this.type,this.closable=this.closable,this.closable&&this.initCloseEvent(),this.effect=this.effect}connectedCallback(){this.init()}}G=new WeakMap,te=new WeakMap;const at=`
@import url('/ea_ui_component/icon/index.css');
...
`,mt=o=>`
    ...
    `;var oe,se,A,ne;class ft extends g{constructor(){super();d(this,oe,void 0);d(this,se,void 0);d(this,A,void 0);d(this,ne,void 0);const e=this.attachShadow({mode:"open"}),t=document.createElement("div");t.className="ea-avatar_wrap";const r=document.createElement("span");r.className="ea-avatar",r.innerHTML=bt,t.appendChild(r);const s=document.createElement("slot");r.appendChild(s);const c=document.createElement("img");r.appendChild(c),n(this,oe,t),n(this,se,s),n(this,A,r),n(this,ne,c),this.build(e,pt),this.shadowRoot.appendChild(t)}get size(){const e=this.getAttrNumber("size"),t=this.getAttribute("size");return e===0||!e?["large","medium","small"].includes(t)?t:"normal":this.getAttrNumber("size")}set size(e){this.setAttribute("size",e),i(this,A).classList.add(`ea-avatar--${e}`)}get shape(){const e=this.getAttribute("shape");return["circle","square"].includes(e)?e:"circle"}set shape(e){this.setAttribute("shape",e),i(this,A).classList.add(`ea-avatar--${this.shape}`)}get src(){return this.getAttribute("src")}set src(e){if(!e)return;const t=new Image;t.src=e,t.onload=()=>{this.setAttribute("src",e),i(this,A).innerHTML=`<img class="ea-avatar--img" src="${e}" alt="头像">`},t.onerror=r=>{this.setAttribute("src",e),i(this,A).innerHTML=gt,this.dispatchEvent(new CustomEvent("error",{detail:{error:r}}))}}get icon(){return this.getAttribute("icon")}set icon(e){this.setAttribute("icon",e),i(this,A).innerHTML=mt(e)}get fit(){return this.getAttribute("fit")||"cover"}set fit(e){this.setAttribute("fit",e),i(this,A).classList.add(`ea-avatar-fill--${e}`)}init(){this.size=this.size,this.shape=this.shape,this.src=this.src,this.src&&(this.fit=this.fit),!this.src&&this.icon&&(this.icon=this.icon),this.innerHTML!==""&&!this.icon&&!this.src&&(i(this,A).innerHTML=_t(this.innerHTML))}connectedCallback(){this.init()}}oe=new WeakMap,se=new WeakMap,A=new WeakMap,ne=new WeakMap;const b=(o,a)=>{window.customElements.get(o)||window.customElements.define(o,a)};b("ea-button",fe);b("ea-button-group",xe);b("ea-link",ve);b("ea-radio",Ee);b("ea-radio-group",ze);b("ea-checkbox",Pe);b("ea-checkbox-group",$e);b("ea-input",qe);b("ea-textarea",Ve);b("ea-input-number",Fe);b("ea-select",Ye);b("ea-switch",Je);b("ea-rate",et);b("ea-tag",rt);b("ea-progress",st);b("ea-pagination",lt);b("ea-badge",ut);b("ea-avatar",ft);
