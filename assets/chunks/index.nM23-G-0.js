var z=(r,o,t)=>{if(!o.has(r))throw TypeError("Cannot "+t)};var n=(r,o,t)=>(z(r,o,"read from private field"),t?t.call(r):o.get(r)),s=(r,o,t)=>{if(o.has(r))throw TypeError("Cannot add the same private member more than once");o instanceof WeakSet?o.add(r):o.set(r,t)},h=(r,o,t,e)=>(z(r,o,"write to private field"),e?e.call(r,t):o.set(r,t),t);var i=(r,o,t)=>(z(r,o,"access private method"),t);import{B as G}from"./Base.yCeCPjNm.js";import"./index.CD0stXPe.js";import{a as k,c as S}from"./createElement.BM9xfELw.js";const X=`
.ea-tab_wrap {
