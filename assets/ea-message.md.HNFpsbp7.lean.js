const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/index.D9ndnvpo.js","assets/chunks/Base.CUnbq9tS.js","assets/chunks/timeout.Cw2pzw4m.js","assets/chunks/ea-message-box.BryfkURS.js","assets/chunks/framework.B6OgyADx.js","assets/chunks/ea-dropdown.Ci_E9DjF.js","assets/chunks/ea-container.Cxx_hwcX.js","assets/chunks/ea-message.tIrRNDdw.js","assets/chunks/ea-notification.BpdLLmaM.js"])))=>i.map(i=>d[i]);
import{y,X as p,c as F,o as c,a3 as t,j as s}from"./chunks/framework.B6OgyADx.js";import{p as h}from"./chunks/ea-message.tIrRNDdw.js";import"./chunks/Base.CUnbq9tS.js";import"./chunks/timeout.Cw2pzw4m.js";const u=t("",12),C=s("div",{class:"demo row"},[s("ea-button",{plain:"",onclick:`
        ...
        `}," Use HTML string ")],-1),_=t("",2),v=s("div",{id:"placementSection",class:"demo row"},[s("ea-button",{plain:""}," Top "),s("ea-button",{plain:""}," Top Left "),s("ea-button",{plain:""}," Top Right "),s("ea-button",{plain:""}," Bottom "),s("ea-button",{plain:""}," Bottom Left "),s("ea-button",{plain:""}," Bottom Right ")],-1),w=t("",10),f=[u,C,B,m,b,A,q,D,_,v,w],x=JSON.parse('{"title":"Message 消息提示","description":"","frontmatter":{},"headers":[],"relativePath":"ea-message.md","filePath":"ea-message.md","lastUpdated":1766827952000}'),T={name:"ea-message.md"},V=Object.assign(T,{setup(S){return y(()=>{p(()=>import("./chunks/index.D9ndnvpo.js"),__vite__mapDeps([0,1,2,3,4,5,6,7,8])),p(()=>Promise.resolve({}),[]),{moduleInstanceBtn:document.getElementById("moduleInstanceBtn"),chainInstanceBtn:document.getElementById("chainInstanceBtn"),init(){this.moduleInstanceBtn.addEventListener("click",()=>{h({message:"This is a message.",type:"info",showClose:!1,duration:3e3})}),this.chainInstanceBtn.addEventListener("click",()=>{h.info("This is a message.")})}}.init();let l=0,e=0,E=0,d=0,r=0,g=0;const o=(n="top")=>{let a=0,i="success";switch(n){case"top":a=++l,i="success";break;case"bottom":a=++e,i="warning";break;case"top-left":a=++E,i="info";break;case"top-right":a=++d,i="primary";break;case"bottom-left":a=++r,i="warning";break;case"bottom-right":a=++g,i="error";break}h({message:`This is a message from the ${n} ${a}`,type:i,placement:n})};({els:document.querySelectorAll("#placementSection ea-button"),init(){this.els.forEach(n=>{n.addEventListener("click",()=>{var i;const a=(i=n.textContent.trim().toLocaleLowerCase())==null?void 0:i.replace(" ","-");o(a)})})}}).init()}),(k,l)=>(c(),F("div",null,f))}});export{x as __pageData,V as default};
