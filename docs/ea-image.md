...
| ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------ | ------ |
| src                                  | 图片地址                                                                                                                      | String  | —                                          | —      |
| fit                                  | 确定图片如何适应容器框，同原生 [object-fit](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Properties/object-fit) | String  | fill / contain / cover / none / scale-down | —      |
...
| previewSrcList <ea-tag>Prop</ea-tag> | 预览图片地址列表                                                                                                              | Array   | —                                          | []     |
