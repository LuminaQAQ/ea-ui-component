...
<div class="demo">
  <ea-statistic heading="Daily active users" value="268500"></ea-statistic>
  ...
  <ea-statistic heading="Total Transactions" value="172000"></ea-statistic>
  <ea-statistic heading="Feedback number" value="562">
    <div slot="suffix">
...
<div class="demo">
  <ea-countdown id="countdown1" heading="Start to grab"></ea-countdown>
  <div style="display:flex;align-items:center;justify-content:center;flex-direction:column;">
    <ea-countdown id="countdown2" heading="Remaining VIP time" format="HH:mm:ss"></ea-countdown>
  ...
  <div style="display:flex;align-items:center;justify-content:center;flex-direction:column;">
    <ea-countdown id="countdown3" heading="Countdown" format="DD [days] HH:mm:ss">
...
<div class="demo row">
  ...
  <div class="statistic-card">
    <ea-statistic value="72000" heading="New transactions today">
...
| format                             | 显示格式（支持 dayjs 风格或组件自定义占位符），例如 `HH:mm:ss` | string             | -      | HH:mm:ss |
| heading                            | 标题文本                                                       | string             | -      | -        |
| refresh-interval                   | 刷新间隔（ms），默认 1000ms                                    | number             | -      | 1000     |
| displayValue <ea-tag>prop</ea-tag> | 显示值，当前倒计时的显示文本                                   | string             | -      | -        |
